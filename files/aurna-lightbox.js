		...
		function aurnaIframe(html){
			var src = html;
			document.getElementById('lightboxframe1').innerHTML = src;
	...
	var AurnaIframe = document.createElement('div');
		AurnaIframe.setAttribute("id", "lightboxframe1");
		AurnaIframe.style.cssText = 'overflow-y: scroll; border:none; height:35em; width: 100%; padding-left: 30px; padding-top: 0px; text-align: left;';
